        ...
        <script>
            $(document).ready(function () {
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "admin_unblock_tm_ajax.jsp", //this is my servlet
                        data: "input=" + val1,
                ...
                <div class="content-main">
                    ...
                    <div class="banner">
                        <h2>
                            ...
                            <span>Unblock Tender Manager</span>
                        </h2>
                    </div>
                    <!--//banner-->
                    <!--blank-->
                    ...
                    <div class="blank">                                                              
                        <div class="blank-page">
                            <%
                                ...
                                String TM_ID = "";
                                int count_tm = 0;
                                PreparedStatement ps_tm_count = con.prepareStatement("select * from tender_manager_login where approve=2 and block = 1");
                                ...
                                if (flag == 1) {
                            %>
                            <form action="Admin_unblock_tm" method="get">                                
                                <div class="table-css">
                                    <table align="center" id = "output">
                                        ...
                                        <%
                                            ...
                                            String tm_id = "";
                                            PreparedStatement ps_tm_disp = con.prepareStatement("select * from tender_manager_login where approve=2 and block = 1 limit 0,5");
