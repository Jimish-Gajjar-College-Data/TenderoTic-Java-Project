...
<html>
    <head>
        ...
        <!--<link href="dashboard_css/bootstrap.css" rel='stylesheet' type='text/css' />-->
        <!-- Custom Theme files -->
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                <div class="content-main">
                    ...
                    <div class="blank">
                        <div class="blank-page">
                            <%
                                ...
                                mdEnc.update(current_pass.getBytes(), 0, current_pass.length());
                                current_pass = new BigInteger(1, mdEnc.digest()).toString(16); // Encrypted string
                                /* // MD5 Password */

                                String Current_pass = "";
                                ps = con.prepareStatement("select * from admin_login where Admin_id='" + Admin_id + "'");
                                rs = ps.executeQuery();
                                while (rs.next()) {
                                    Current_pass = rs.getString("Admin_Password");
                                }
                                if (current_pass.equals(Current_pass)) {
                            %>
                            <script>
                            ...
                            <form action="Admin_change_pass" method="get" role="form" onsubmit="return validate(this)" class="form-horizontal">
                    ...
                    <%} else {
                            out.println("<Script> alert('You enter password is incorrect'); window.location.replace('admin_change_pass.jsp');</script>");
                        }%>
                    <!-- // enter password -->
                    <!---->
                    <div class="copy">
                        <p> &copy; 2016 TenderoTic. All Rights Reserved | Design by <a href="" target="">TenderoTic</a> </p>	  
                    </div>
                </div>
            </div>
            <div class="clearfix"> </div>
