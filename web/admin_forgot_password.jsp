...
<%
    ...
    String ADMIN_OTP_ID = (String) session.getAttribute("Otp_Admin");

    if (ADMIN_OTP_ID == null) {
...
<html>
    ...
    <body>
        <%
            ...
            String admin_otp = request.getParameter("A_otp");
            /* MD5 Password */
            MessageDigest mdEnc = MessageDigest.getInstance("MD5"); //Encryption algorithm
            mdEnc.update(admin_otp.getBytes(), 0, admin_otp.length());
            admin_otp = new BigInteger(1, mdEnc.digest()).toString(16); // Encrypted string
            /* // MD5 Password */

            PreparedStatement ps_otp = con.prepareStatement("select * from admin_login where Admin_id = '" + ADMIN_OTP_ID + "'AND Admin_Password = '" + admin_otp + "'");
            ResultSet rs_otp = ps_otp.executeQuery();
            if (rs_otp.next()) {%>
        <script type="text/javascript">
            $(document).ready(function () {
                $('#Admin_change_pass').modal('show');
            });
        </script>
        <%} else {%>
        <Script> alert('You enter otp is wrong'); window.location.replace('admin_forgot_otp.jsp');</script>
            <%}%>
        <!-- Admin Enter Otp -->
        <div class="modal bnr-modal fade" id="Admin_change_pass" tabindex="-1" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <section>
                        <div class="modal-body modal-spa">
                            ...
                            <form action="Admin_forgot_password" method="get" onsubmit="return validate(this)">                                
                        ...
                        <section>
                            <div class="modal-body modal-spa">
                                ...
                                <div class="Site_admin" style="display: none;">
                                    <font color="#000"><h4 align="center">Forgot Password</h4></font><br>                                    
                                    <form action="Admin_forgot_password" method="get" onsubmit="return validate(this)">                                
                                        <label>New Password :</label>
                                        <input type="password" name="new_pass" placeholder="New password" required="" minlength="8">
                                        <label>Conform New Password :</label>
