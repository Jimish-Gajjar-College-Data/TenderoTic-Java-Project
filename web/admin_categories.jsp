                            ...
                            <div class="form-group">
                                <div class="col-md-4">
                                    <div class="profile-fo">
                                        <a href="admin_categories_add.jsp" class="pro1"><i class="fa fa-plus"></i>Add Category</a>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="profile-fo">
                                        <a href="tenderer_view_tender_all.jsp" class="pro1"><i class="fa fa-pencil"></i>Update Category</a>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="profile-fo">
                                        <a href="tenderer_view_tender_sear_category.jsp" class="pro1"><i class="fa fa-trash"></i>Delete Category</a>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"> </div><br>
                            <div id="cat-tab">
                                <div class="table-css-category" id="View" style="overflow-x:auto;">
                                    <h6><table align = "center">
                                            <tr>
                                                <th>TITLE</th>                
                                                <th>DESCRIPTION</th>                
                                            </tr>
                                            <%
                                                PreparedStatement view_tender = con.prepareStatement("SELECT * FROM category limit 0,5");
