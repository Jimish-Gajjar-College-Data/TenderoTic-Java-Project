        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                <div class="content-main">
                    ...
                    <!-- tenderer view tender -->
                    <div class="blank">
                        <div class="blank-page">
                            <div class="form-group">
                                <div class="col-md-4">
                                    <div class="profile-fo">
                                        <a href="tenderer_view_tender_sear_month.jsp" class="pro1"><i class="fa fa-calendar"></i>Month</a>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="profile-fo">
                                        <a href="tenderer_view_tender_all.jsp" class="pro1"><i class="fa fa-bars"></i>View All</a>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="profile-fo">
                                        <a href="tenderer_view_tender_sear_category.jsp" class="pro1"><i class="fa fa-file-text"></i>Category Wise</a>
                                    </div>
                                </div>
                            </div>
                            <div class="clearfix"> </div>
