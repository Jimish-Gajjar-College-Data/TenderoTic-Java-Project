...
//              pre_year=rs_nrf.getInt("YEAR(now())");
//            }
                                        PreparedStatement ps_nrf1 = con.prepareStatement("SELECT * FROM tenderer_regis_tab where month(reg_date)='" + prev_month + "'and year(reg_date)='" + pre_year + "'");
                                        ResultSet rs_nrf1 = ps_nrf1.executeQuery();
                                        while (rs_nrf1.next()) {
                                            today_nrf++;
                                        }

                                        PreparedStatement ps_nrf2 = con.prepareStatement("SELECT * FROM tenderer_regis_tab where month(reg_date)<'" + prev_month + "'and year(reg_date)='" + pre_year + "'");
                                        ResultSet rs_nrf2 = ps_nrf2.executeQuery();
                                        while (rs_nrf2.next()) {
                                            total_nrf++;
                                        }
                                        total_year1 = today_nrf + total_nrf;
                                        today_nrf = ((today_nrf / total_nrf) * 100);
                                        System.out.println(today_nrf);

                                    %>
                                    <h5>New Company Registered</h5>
                                    <h5>(fillers)</h5>
...
//                                   
                                        PreparedStatement ps_nrp1 = con.prepareStatement("SELECT * FROM tender_manager_regis_tab where month(reg_date)='" + prev_month + "'and year(reg_date)='" + pre_year + "'");
                                        ResultSet rs_nrp1 = ps_nrp1.executeQuery();
                                        while (rs_nrp1.next()) {
                                            today_nrp++;
                                        }

                                        PreparedStatement ps_nrp2 = con.prepareStatement("SELECT * FROM tender_manager_regis_tab where month(reg_date)<'" + prev_month + "'and year(reg_date)='" + pre_year + "'");
                        ...
                        <div class="col-md-8 content-top-2" id="chart" style="width:725px;">
                            ...
                            <div class="content-graph"  style="width:725px; overflow-x:auto;">
                                ...
                                <%
                                    ...
                                    System.out.print(ctr);
                                    PreparedStatement pst1 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='1'");
                                    ResultSet rst1 = pst1.executeQuery();
                                    while (rst1.next()) {
                                        jan1++;
                                    }
                                    PreparedStatement pst2 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='2'");
                                    ResultSet rst2 = pst2.executeQuery();
                                    while (rst2.next()) {
                                        feb1++;
                                    }
                                    PreparedStatement pst3 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='3'");
                                    ResultSet rst3 = pst3.executeQuery();
                                    while (rst3.next()) {
                                        mar1++;
                                    }
                                    PreparedStatement pst4 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='4'");
                                    ResultSet rst4 = pst4.executeQuery();
                                    while (rst4.next()) {
                                        apr1++;
                                    }
                                    PreparedStatement pst5 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='5'");
                                    ResultSet rst5 = pst5.executeQuery();
                                    while (rst5.next()) {
                                        may1++;
                                    }
                                    PreparedStatement pst6 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='6'");
                                    ResultSet rst6 = pst6.executeQuery();
                                    while (rst6.next()) {
                                        jun1++;
                                    }
                                    PreparedStatement pst7 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='7'");
                                    ResultSet rst7 = pst7.executeQuery();
                                    while (rst7.next()) {
                                        jul1++;
                                    }
                                    PreparedStatement pst8 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='8'");
                                    ResultSet rst8 = pst8.executeQuery();
                                    while (rst8.next()) {
                                        aug1++;
                                    }

                                    PreparedStatement pst9 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='9'");
                                    ResultSet rst9 = pst9.executeQuery();
                                    while (rst9.next()) {
                                        sep1++;
                                    }
                                    PreparedStatement pst10 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='10'");
                                    ResultSet rst10 = pst10.executeQuery();
                                    while (rst10.next()) {
                                        oct1++;
                                    }
                                    PreparedStatement pst11 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='11'");
                                    ResultSet rst11 = pst11.executeQuery();
                                    while (rst11.next()) {
                                        nov1++;
                                    }
                                    PreparedStatement pst12 = con.prepareStatement("SELECT * FROM `fill_tender` WHERE YEAR(date_of_fill)='" + ctr + "' and MONTH(date_of_fill)='12'");
