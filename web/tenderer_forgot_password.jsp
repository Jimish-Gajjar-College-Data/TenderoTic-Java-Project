...
<%
    ...
    String TENDERER_OTP = (String) session.getAttribute("Otp_Tendere_id");

    if (TENDERER_OTP == null) {
...
<html>
    ...
    <body>
        <%
            ...
            String tenderer_otp = request.getParameter("T_otp");
            /* MD5 Password */
            MessageDigest mdEnc = MessageDigest.getInstance("MD5"); //Encryption algorithm
            mdEnc.update(tenderer_otp.getBytes(), 0, tenderer_otp.length());
            tenderer_otp = new BigInteger(1, mdEnc.digest()).toString(16); // Encrypted string
            /* // MD5 Password */

            PreparedStatement ps_otp = con.prepareStatement("select * from tenderer_login where tenderer_id = '" + TENDERER_OTP + "'AND password = '" + tenderer_otp + "'");
            ResultSet rs_otp = ps_otp.executeQuery();
            if (rs_otp.next()) {%>
        <script type="text/javascript">
            $(document).ready(function () {
                $('#Tenderer_change_pass').modal('show');
            });
        </script>
        <%} else {%>
        <Script> alert('You enter otp is wrong'); window.location.replace('tenderer_forgot_otp.jsp');</script>
            <%}%>
        <!-- Admin Enter Otp -->
        <div class="modal bnr-modal fade" id="Tenderer_change_pass" tabindex="-1" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <section>
                        <div class="modal-body modal-spa">
                            ...
                            <form action="Tenderer_forgot_password" method="get" onsubmit="return validate(this)">                                
                                <label>New Password :</label>
                                <input type="password" name="new_pass" placeholder="New password" required="" minlength="8">
                                <label>Conform New Password :</label>
                                <input type="password" name="confirm_new_pass" placeholder="Confirm New Password" required="" minlength="8">                                        
                        ...
                        <section>
                            <div class="modal-body modal-spa">
                                ...
                                <div class="Site_admin" style="display: none;">
                                    ...
                                    <input type="text" name="Admin_id" placeholder="Enter Username" required="">                                        
                                    <input type="submit" value="Change" id="otp">
                                </div>
                                <div class="clearfix"> </div>
                            </div>
                        </section>
