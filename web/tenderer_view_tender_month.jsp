        ...
        <script>
            $(document).ready(function () {
                ...
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "tenderer_view_tender_month_ajax.jsp", //this is my servlet
                ...
                <div class="content-main">
                    ...
                    <div class="banner">
                        <h2>
                            ...
                            <a href="tenderer_view_tender.jsp">View Tender</a>
                            <i class="fa fa-angle-right"></i>
                            <a href="tenderer_view_tender_sear_month.jsp">Select Month</a>
                            <i class="fa fa-angle-right"></i>
                            <span>View</span>
                        </h2>
                    </div>
                            ...
                            <div class="table-view-tender" id="View"  style="overflow-x:auto;">                                   
                                <h6><table id="output">
                                        ...
                                        <%
                                            ...
                                            PreparedStatement view_tender = con.prepareStatement("SELECT *,name FROM tender_info t , product p  WHERE t.product_id = p.product_id and MONTH(reg_date)='" + month + "'limit 0,5");
