        ...
        <script>
            $(document).ready(function () {
                ...
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "tm_view_tender_category_ajax.jsp", //this is my servlet
                ...
                <div class="content-main">
                    ...
                    <div class="banner">
                        <h2>
                            ...
                            <i class="fa fa-angle-right"></i>
                            <a href="tm_view_tender_sear_category.jsp">Select Category</a>
                            <i class="fa fa-angle-right"></i>
                            <span>View</span>
                        </h2>
                    </div>
                    ...
                    <div class="blank">
                        <div class="blank-page">
                            <%
                                ...
                                PreparedStatement count_tender = con.prepareStatement("SELECT *,name FROM tender_info t , product p  WHERE t.product_id = p.product_id and category_id ='" + select_cat + "'");
                            ...
                            <div class="table-view-tender" id="View"  style="overflow-x:auto;">                                   
                                <h6><table id="output">
                                        ...
                                        <%
                                            ...
                                            PreparedStatement view_tender = con.prepareStatement("SELECT *,name FROM tender_info t , product p  WHERE t.product_id = p.product_id and category_id ='" + select_cat + "' and tm_id = '" + TM_id + "'limit 0,5");
