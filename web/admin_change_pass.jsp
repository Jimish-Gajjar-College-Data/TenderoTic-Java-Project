                ...
                <div class="content-main">
                    ...
                    <div class="blank">
                        <div class="blank-page">
                            <form action="admin_change_new_pass.jsp" role="form" class="form-horizontal">
                                <div class="form-group">
                                    <div class="col-md-8 col-lg-offset-2">
                                        <div class="input-group">							
                                            ...
                                            <input type="password" class="form-control1" name="current_pass" placeholder="Current password" required="">
                                        </div>
                                    </div>
                                </div>
