...
<html>
    ...
    <body>
        ...
        %>
        <!-- Admin Enter Otp -->
        <div class="modal bnr-modal fade" id="Tenderer_otp" tabindex="-1" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <section>
                        <div class="modal-body modal-spa">
                            ...
                            <form action="tenderer_forgot_password.jsp">                                
                                <label>Enter OTP :</label>
                                <input type="password" name="T_otp" placeholder="Enter One Time Password" required="">                                        
