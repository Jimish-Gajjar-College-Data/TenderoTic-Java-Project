                        ...
                        <section>
                            <div class="modal-body modal-spa">
                                ...
                                <div class="Tenderer_login" style="display: none;">
                                    <font color="#000"><h4 align="center">Change Password</h4></font><br>                                    
                                    <form action="Tenderer_otp_send" method="get"> 
                                        <input type="text" name="Tenderer_id" placeholder="Enter Username" required="">                                        
                                        <input type="submit" value="Change">
                                    </form>
                                </div>
                        ...
                        <section>
                            <div class="modal-body modal-spa">
                                ...
                                <div class="Tm_login" style="display: none;">
                                    <font color="#000"><h4 align="center">Change Password</h4></font><br>                                    
                                    <form action="TM_otp_send" method="get"> 
                                        <input type="text" name="TM_id" placeholder="Enter Username" required="">                                        
                                        <input type="submit" value="Change">
                                    </form>
                                </div>
        ...
        <div class="team" id="team">
            <div class="container">
                ...
                <div class="team-row">
                    ...
                    <div class="col-md-3 team-grids">
                        <img class="img-responsive" src="images/imge2.JPG" alt="">
                        <div class="captn">
                            <h4></h4>
                            <p>Back End Design</p>
                            <div class="social-icons">
                    ...
                    <div class="col-md-3 team-grids">
                        <img class="img-responsive" src="images/imeg3.JPG" alt="">
                        <div class="captn">
                            <h4>Jimsih </h4>
                            <p>Site Manager</p>
                            <div class="social-icons">
                    ...
                    <div class="col-md-3 team-grids">
                        <img class="img-responsive" src="images/imge4.JPG" alt="">
                        <div class="captn">
