        ...
        <script>
            $(document).ready(function () {
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "admin_unblock_tenderer_ajax.jsp", //this is my servlet
                        data: "input=" + val1,
                    ...
                    <div class="blank">                                                              
                        <div class="blank-page">
                            <%
                                ...
                                int flag = 0;
                                String TENDERER_ID = "";
                                PreparedStatement ps_tenderer_count = con.prepareStatement("select * from tenderer_login where approve=2 and block = 1");
                                ...
                                if (flag == 1) {
                            %>
                            <form action="Admin_unblock_tenderer" method="get">
                                <div class="table-css">
                                    <table align="center" id="output">
                                        ...
                                        <%
                                            ...
                                            String tenderer_id = "";
                                            PreparedStatement ps_view_tenderer = con.prepareStatement("select * from tenderer_login where approve=2 and block = 1 limit 0,5");
