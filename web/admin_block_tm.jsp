                ...
                <div class="content-main">
                    ...
                    <div class="banner">
                        <h2>
                            ...
                            <span>Block Tender Manager</span>
                        </h2>
                    </div>
                    <!--//banner-->
                    <!--blank-->
                    ...
                    <div class="blank">                                                              
                        <div class="blank-page">
                            <%
                                ...
                                if (flag == 1) {
                            %>
                            <form action="Admin_block_tm" method="get">                                
                                <div class="table-css">
                                    <table align="center" id = "output">
                                        ...
                                        <%
                                            ...
                                            String tm_id = "";
                                            PreparedStatement ps_tm_disp = con.prepareStatement("select * from tender_manager_login where approve = 2 and block = 0 limit 0,5");
