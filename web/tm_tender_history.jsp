        ...
        <script>
            $(document).ready(function () {
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "tm_tender_history_ajax.jsp", //this is my servlet
                        data: "input=" + val1,
                            ...
                            <div class="table-view-tender" id="View"  style="overflow-x:auto;">                                   
                                <h6><table id="output">
                                        ...
                                        <%
                                            ...
                                            PreparedStatement view_tender = con.prepareStatement("select ti.tender_id, ti.title,ti.category_id,ti.product_id,p.name,c.title,ti.reg_date,ti.result_dec_date from category c, tender_info ti, product p where ti.tm_id='" + TM_id + "' and ti.product_id=p.product_id and ti.category_id=c.category_id limit 0,5");
