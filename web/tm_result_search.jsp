...
<html>
    ...
    $(document).ready(function () {
              ...
              var val5=document.getElementById("category_id").value;
                    ...
                    $.ajax({
                        url: "tm_search_result_ajax.jsp", //this is my servlet
                ...
                <div class="content-main">
                    ...
                    <div class="content-top" >
                        <%
                            ...
                            int prev_month = 0, pre_year = 0, cur_month = 0, tender_id = 0, flag = 0;
                            int category_id = 0;
...
//                                        
                            ...
                            System.out.println("ctegory" + category_id + total_year2+prev_tender+total_tender+category_id);
                            if (flag == 1 || flag == 2) {
                        %>
                        <div class="col-md-4 ">
                        ...
                        <div class="col-md-8 content-top-2" id="chart"  style="width:700px;" >
                            ...
                            <div class="content-graph"  style="width:700px;">
                                <div class="content-color" >
                                    <%if (flag == 1) {%>
                                    <div class="content-ch"><p><i></i>Tender Filled for tender posted in this year</p>
                                        <div class="clearfix"> </div>
                                    </div>
                                    <%} else if (flag == 2) {%>
