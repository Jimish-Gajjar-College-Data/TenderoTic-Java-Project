        ...
        <script>
            $(document).ready(function () {
                ...
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "tm_view_tender_month_ajax.jsp", //this is my servlet
                        data: "input=" + val1 + "&month=" + mon,
                ...
                <div class="content-main">
                    ...
                    <div class="banner">
                        <h2>
                            ...
                            <a href="tm__view_tender.jsp">View Tender</a>
                            <i class="fa fa-angle-right"></i>
                            <a href="tm_view_tender_search_month.jsp">Select Month</a>
                            <i class="fa fa-angle-right"></i>
                            <span>View</span>
                        </h2>
                    </div>
                    ...
                    <div class="blank">
                        <div class="blank-page">
                            <%
                                ...
                                PreparedStatement count_tender = con.prepareStatement("SELECT *,name FROM tender_info t , product p  WHERE t.product_id = p.product_id and MONTH(reg_date)='" + month + "'");
                            ...
                            <div class="table-view-tender" id="View"  style="overflow-x:auto;">                                   
                                <h6><table id="output">
                                        ...
                                        <%
                                            ...
                                            PreparedStatement view_tender = con.prepareStatement("SELECT *,name FROM tender_info t , product p  WHERE t.product_id = p.product_id and MONTH(reg_date)='" + month + "' and tm_id = '" + TM_id + "'limit 0,5");
