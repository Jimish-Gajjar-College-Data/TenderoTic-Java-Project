    ...
    <body>
        ...
        <table align="center" id="output">
            ...
            <% 
                /* cont five tm */
                int pagenation = 1;
                double total_tm = (double) count_tenderer / 5;
                double no_record = 0;
                ...
                String tenderer_id = "";
                PreparedStatement ps_view_tenderer = con.prepareStatement("select * from tenderer_login where approve=2 and block = 0 limit " + start + "," + end);
