                ...
                <div class="content-main">
                    ...
                    <div class="banner">
                        <h2>
                            ...
                            <a href="tm_select_result_tender.jsp">Select Result Tender</a>
                            <i class="fa fa-angle-right"></i>
                            ...
                            <div class="table-view-tender" style="overflow-x:auto;">
                                <table align="center">
                                    ...
                                    <%
                                        double score = 0;
                                        double sc_price = 0;
                                        int tender_id = Integer.parseInt(request.getParameter("select_tender"));
                                        String tender_price = "";
                                        int price1 = 0;
                                        int price = 0;
                                        String tenderer_id = "";

                                        PreparedStatement ps_co2 = con.prepareStatement("select tender_id, date_of_fill,price , tenderer_id from fill_tender where  tender_id = '" + tender_id + "'order by price ");
                                        ResultSet rs_co2 = ps_co2.executeQuery();
                                        while (rs_co2.next()) {
                                    %>
                                    <tr>
                                        <td><%=rs_co2.getInt("tender_id")%></td>
                                        <td><%=rs_co2.getString("tenderer_id")%></td>
                                        <td><%=rs_co2.getDate("date_of_fill")%></td>
                                        <td><%=rs_co2.getInt("price")%></td>
                                        <td><input type="button" name="details" value="SHOW DETAILS"> <input type="submit" name="win" value="DECLARE WINNER"></td>
                                    </tr>     
                                    <%}%>
                                </table>
                            </div>
