        ...
        <script>
            $(document).ready(function () {
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "admin_tender_approve_ajax.jsp", //this is my servlet
                        data: "input=" + val1,
                    ...
                    <div class="blank">                                                              
                        <div class="blank-page">
                            <%
                                int count_tende = 0;
                                int flag = 0;
                                PreparedStatement count_tender = con.prepareStatement("SELECT * FROM tender_info where approve = 0");
                                ...
                                if (flag == 1) {
                            %>
                            <form action="Admin_tender_approve" method="get">
                                <div class="table-view-tender" style="overflow-x:auto;">                                   
                                    <h6><table id="output">
                                            ...
                                            <%
                                                ...
                                                PreparedStatement view_tender = con.prepareStatement("SELECT * FROM tender_info where approve = 0 limit 0,5");
