...
<%
    ...
    String ADMIN_OTP = (String) session.getAttribute("Otp_Admin");
...
<html>
    ...
    <body>
        ...
        %>
        <!-- Admin Enter Otp -->
        <div class="modal bnr-modal fade" id="Admin_otp" tabindex="-1" role="dialog">
                ...
                <div class="modal-content">
                    ...
                    <section>
                        <div class="modal-body modal-spa">
                            ...
                            <form action="admin_forgot_password.jsp">                                
                                <label>Enter OTP :</label>
                                <input type="password" name="A_otp" placeholder="Enter One Time Password" required="">                                        
