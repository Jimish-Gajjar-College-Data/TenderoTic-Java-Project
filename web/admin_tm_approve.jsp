        ...
        <script>
            $(document).ready(function () {
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "admin_tm_approve_ajax.jsp", //this is my servlet
                        data: "input=" + val1,
                ...
                <div class="content-main">
                    ...
                    <div class="banner">
                        <h2>
                            ...
                            <span>Approve Tender Manager</span>
                        </h2>
                    </div>
                    <!--//banner-->
                    <!--blank-->
                    ...
                    <div class="blank">                                                              
                        <div class="blank-page">
                            <%
                                ...
                                int count_tm = 0;
                                int flag = 0;
                                PreparedStatement ps_tm_count = con.prepareStatement("select * from tender_manager_login where approve=0");
                                ...
                                if (flag == 1) {
                            %>
                            <form action="Admin_tm_approve" method="get">                                
                                <div class="table-css">
                                    <table align="center" id = "output">
                                        ...
                                        <%
                                            ...
                                            String tm_id = "";
                                            PreparedStatement ps_tm_disp = con.prepareStatement("select * from tender_manager_login where approve=0 limit 0,5");
