...
--
-- Host: 127.0.0.1
-- Generation Time: May 23, 2017 at 11:00 PM
...
('jimish.gajjar@gmail.com', '4d5a35c2a9319e57f5e2913ea97df173', 'Jimish Gajjar', 'tenderer.jpg');
...
CREATE TABLE `result_tender` (
  ...
  `admin_view` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tenderer_login` (
  ...
  `Read_notification` tinyint(4) NOT NULL DEFAULT '0',
  `tender_posted` tinyint(4) NOT NULL DEFAULT '0',
  `result_dec` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tender_manager_login` (
  ...
  `approve` tinyint(4) NOT NULL DEFAULT '0',
  `Read_notification` tinyint(4) NOT NULL DEFAULT '0',
  `block_tender` tinyint(4) NOT NULL DEFAULT '0',
  `fill_tender_view` tinyint(4) NOT NULL DEFAULT '0',
  `result_view` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `faq`
  MODIFY `faq_id` tinyint(4) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `fill_tender`
  MODIFY `fill_tender_id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `faq`
  ADD CONSTRAINT `faq_ibfk_1` FOREIGN KEY (`tm_id`) REFERENCES `tender_manager_regis_tab` (`tm_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `faq_ibfk_2` FOREIGN KEY (`tender_id`) REFERENCES `tender_info` (`tender_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `fill_tender`
--
ALTER TABLE `fill_tender`
  ADD CONSTRAINT `fill_tender_ibfk_1` FOREIGN KEY (`tender_id`) REFERENCES `tender_info` (`tender_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fill_tender_ibfk_2` FOREIGN KEY (`tenderer_id`) REFERENCES `tenderer_regis_tab` (`tenderer_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `que`
--
ALTER TABLE `que`
  ADD CONSTRAINT `que_ibfk_1` FOREIGN KEY (`tender_id`) REFERENCES `tender_info` (`tender_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `result_tender`
  ADD CONSTRAINT `result_tender_ibfk_1` FOREIGN KEY (`tenderer_id`) REFERENCES `tenderer_regis_tab` (`tenderer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `result_tender_ibfk_2` FOREIGN KEY (`tender_id`) REFERENCES `tender_info` (`tender_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `tenderer_regis_tab`
  ADD CONSTRAINT `tenderer_regis_tab_ibfk_1` FOREIGN KEY (`city_id`) REFERENCES `city` (`city_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `tender_info`
--
ALTER TABLE `tender_info`
  ADD CONSTRAINT `tender_info_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `category` (`category_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tender_info_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `tender_info_ibfk_3` FOREIGN KEY (`tm_id`) REFERENCES `tender_manager_regis_tab` (`tm_id`) ON DELETE CASCADE ON UPDATE CASCADE;
