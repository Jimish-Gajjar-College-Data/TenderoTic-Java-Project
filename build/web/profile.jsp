                            ...
                            <div class="profile-bottom">
                                ...
                                <div class="profile-bottom-top">
                                    <div class="col-md-4 profile-bottom-img">                                                                            
                                        <div  class="post-file">
                                            <input type="image" class="img-circle img_text" src="<%= path%>" alt="" height="150" width="150" required="">
                                ...
                                <div class="profile-bottom-bottom">
                                    <div class="col-md-4 profile-fo">
                                        <input type="submit" class="bttn" value="Save Profile">
                                    </div>
                                    <div class="col-md-4 profile-fo">
                                        <a href="admin_change_pass.jsp" class="pro1"><i class="fa fa-key"></i>Change Password</a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
