...
<html>
    ...
    <body>
        <%
            ...
            PreparedStatement count_tender = con.prepareStatement("SELECT *,name FROM tender_info t , product p  WHERE t.product_id = p.product_id and MONTH(reg_date)='" + month + "' and tm_id ='"+TM_id+"'");
        ...
        <table id="output">
            ...
            <%
                ...
                PreparedStatement view_tender = con.prepareStatement("SELECT *,name FROM tender_info t , product p  WHERE t.product_id = p.product_id and MONTH(reg_date)='" + month + "' and tm_id ='"+TM_id+"' limit " + start + "," + end);
            ...
            <tr>
                ...
                <td><%=rs_viewtender.getString("product_id")%></td>
