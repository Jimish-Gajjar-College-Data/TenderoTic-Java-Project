    ...
    <head>
        ...
        <script>
            $(document).ready(function () {
                var tenderer_id = $("#select_tenderere_id").val();
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "admin_view_tender_result_ajax.jsp", //this is my servlet
                        data: "input=" + val1 + "&select_tenderere_id=" + tenderer_id,
                ...
                <div class="content-main">
                    ...
                    <div class="banner">
                        <h2>
                            ...
                            <i class="fa fa-angle-right"></i>
                            <a href="admin_view_tender_sear_result.jsp">Select Tender Id</a>
                            <i class="fa fa-angle-right"></i>
                            <span>View</span>
                        </h2>
                    </div>
                            ...
                            <div class="table-view-tender" id="View"  style="overflow-x:auto;">                                   
                                <h6><table id="output">
                                        ...
                                        <%
                                            ...
                                            PreparedStatement search_tender = con.prepareStatement("SELECT * FROM result_tender WHERE tenderer_id = '" + select_tenderer_id + "' limit 0,5");
