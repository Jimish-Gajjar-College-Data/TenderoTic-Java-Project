    ...
    <body>
        ...
        <table id="output">
            ...
            <%
                ...
                PreparedStatement view_tender = con.prepareStatement("SELECT *,name FROM tender_info t , product p where t.product_id = p.product_id and category_id ='" + select_cat + "'limit " + start + "," + end);
