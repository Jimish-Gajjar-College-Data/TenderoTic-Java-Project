                            ...
                            <div class="form-group">
                                <div class="col-md-4">
                                    <div class="profile-fo">
                                        <a href="tm_view_tender_search_month.jsp" class="pro1"><i class="fa fa-calendar"></i>Month</a>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="profile-fo">
                                        <a href="tm_view_tender_all.jsp" class="pro1"><i class="fa fa-bars"></i>View All</a>
                                    </div>
                                </div>

                                <div class="col-md-4">
                                    <div class="profile-fo">
                                        <a href="tm_view_tender_sear_category.jsp" class="pro1"><i class="fa fa-file-text"></i>Category Wise</a>
                                    </div>
                                </div>
