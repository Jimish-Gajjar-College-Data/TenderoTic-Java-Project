        ...
        <script>
            $(document).ready(function () {
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "tm_select_result_tender_ajax.jsp", //this is my servlet
                        data: "input=" + val1,
                ...
                <div class="content-main">
                    ...
                    <div class="banner">
                        <h2>
                            ...
                            <span>Select Result Tender</span>
                        </h2>
                    </div>
                    <!--//banner-->
                    <!-- View All Tender Div-->
                                    ...
                                    <h6>                                    
                                        <table id="output">
                                            ...
                                            <%
                                                ...
                                                PreparedStatement view_tender = con.prepareStatement("SELECT * FROM tender_info WHERE tm_id = '" + TM_id + "' AND result_dec_date <= now() limit 0,5");
