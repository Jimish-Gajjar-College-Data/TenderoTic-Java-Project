        ...
        <script>
            $(document).ready(function () {
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "admin_block_tender_ajax.jsp", //this is my servlet
                        data: "input=" + val1,
            ...
            function pagi(element) {
                ...
                if (val <= val2) {
                    ...
                    $.ajax({
                        url: "admin_view_tender_all_ajax.jsp", //this is my servlet
                        data: "input=" + val,
                        success: function (msg) {
                            $('#output').html(msg);
                        }
                    ...
                    <div class="blank">                                                              
                        <div class="blank-page">
                            <%
                                int flag = 0;
                                int count_tende = 0;
                                PreparedStatement count_tender = con.prepareStatement("SELECT * FROM tender_info where approve = 1 and block = 0");
                                ...
                                if (flag == 1) {
                            %>
                            <form action="Admin_block_tender" method="get">
                                <div class="table-view-tender" style="overflow-x:auto;">                                   
                                    <h6><table id="output">
                                            ...
                                            <%
                                                ...
                                                PreparedStatement view_tender = con.prepareStatement("SELECT * FROM tender_info where approve = 1 and block = 0 limit 0,5");
