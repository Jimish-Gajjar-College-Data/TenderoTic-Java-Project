...
<html>
    ...
    <body>
        <%
            ...
            int count_tende = 0;
            PreparedStatement count_tender = con.prepareStatement("SELECT * FROM tender_info");
        ...
        <table id="output">
            ...
            <%
                ...
                int select_cat = Integer.parseInt(request.getParameter("select_category"));
                int page_id = Integer.parseInt(request.getParameter("input"));
                int start = (page_id - 1) * 5;
                int end =  5;
                /* // cont five */

                PreparedStatement view_tender = con.prepareStatement("SELECT *,name FROM tender_info t , product p  WHERE t.product_id = p.product_id and category_id ='" + select_cat + "' and tm_id = '"+TM_id+"'limit " + start + "," + end);
