    ...
    <body>
        ...
        <table id="output">
            ...
            <%
                ...
                PreparedStatement view_tender = con.prepareStatement("SELECT *,name FROM tender_info t , product p  where t.product_id = p.product_id and tm_id = '"+TM_id+"'limit " + start + "," + end);
