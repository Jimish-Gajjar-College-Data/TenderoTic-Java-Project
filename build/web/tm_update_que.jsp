                    ...
                    <div class="blank">
                        <div class="blank-page" id="category">
                            ...
                            <%
                                ...
                                String que = "", op_1 = "", op_2 = "", op_3 = "", op_4 = "", op_5 = "";
                                int ans_type = 0;
                                int count_tende = 0;

                                PreparedStatement count_tender = con.prepareStatement("SELECT * FROM que where tender_id='" + tender_id + "'");
                            ...
                            <div class="table-view-tender" id="View"  style="overflow-x:auto;">                                   
                                <h6><table id="output" align="center">
                                        <tr>
                                            <th>QUESTION</th>
                                            <th></th>
                                            <th>ANSWER TYPE</th> 
                                        ...
                                        <%
                                            ...
                                            String answer_type = "";
                                            /* // cont five */
                                            PreparedStatement ps1 = con.prepareStatement("select * from que where tm_id='" + TM_id + "' and tender_id='" + tender_id + "'");
                                            ResultSet rs1 = ps1.executeQuery();
                                            while (rs1.next()) {
                                                q_id = rs1.getInt("q_id");
                                                que = rs1.getString("question");
                                                ans_type = rs1.getInt("answer_type_id");
                                                if (ans_type == 1) {
                                                    answer_type = "Check Box";
                                                } else if (ans_type == 2) {
                                                    answer_type = "Radio Button";
                                                } else if (ans_type == 3) {
                                                    answer_type = "Text Box";
                                                } else {
                                                    answer_type = "Drop Down";
                                                }
                                                op_1 = rs1.getString("an_op_1");
                                                op_2 = rs1.getString("an_op_2");
                                                op_3 = rs1.getString("an_op_3");
                                                op_4 = rs1.getString("an_op_4");
                                                op_5 = rs1.getString("an_op_5");
                                        %>
                                        <tr>
                                            <td><%=que%></td>
                                            <td></td>
                                            ...
                                            <td>
                                                ...
                                                <form action="TM_delete_question" method="get" id="myForm">
                                                    <input type="hidden" value="<%=tender_id%>" name="tender_id">
                                                    <input type="hidden" value="<%=q_id%>" name="q_id">
                                                    <div  class="post-file">
                                                        <h3><i class="fa fa-trash-o" onclick="myFunction()"></i></h3>
                                                    </div>
                                                    <!--                                                    <input type="submit">-->
                                                </form>
                                            <td>                                                                                    
                            ...
                            <form action="tm_post_tender_questions.jsp" >
                                <div class="col-md-12 col-lg-offset-2 form-group">
