        ...
        <div id="wrapper">
            ...
            <nav class="navbar-default navbar-static-top" role="navigation">
                ...
                <div class=" border-bottom">
                    <div class="full-left">
                        <section class="full-top" style="padding-left: 40px;">
                        ...
                        <ul class=" nav_1">
                            ...
                            <li class="dropdown">
                                <%
                                    ...
                                    PreparedStatement ps = con.prepareStatement("select * from tenderer_regis_tab where tenderer_id='" + Tenderer_id + "'");
                        ...
                        <div class="profile-bottom">
                            ...
                            <div class="profile-bottom-top">
                                <div class="col-md-4 profile-bottom-img">
                                    <img src="<%= path%>" alt="No profile image" height="150" width="150">
                                </div>
                            ...
                            <div class="profile-bottom-bottom">
                                <div class="col-md-4 profile-fo">
                                    <a href="tenderer_edit_profile.jsp" class="pro1"><i class="fa fa-user"></i>Edit Profile</a>
                                </div>
                                <div class="col-md-4 profile-fo">
                                    <a href="tenderer_change_pass.jsp" class="pro1"><i class="fa fa-key"></i>Change Password</a>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
