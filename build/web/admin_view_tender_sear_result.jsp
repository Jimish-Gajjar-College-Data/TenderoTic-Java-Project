                ...
                <div class="content-main">
                    ...
                    <div class="blank">
                        <div class="blank-page">
                            <form action="admin_view_tender_result.jsp">
                                <div class="form-group">
                                    <div class="col-md-8 col-md-offset-2 form-group2 group-mail">
                                        <label class="control-label">Select Tenderer Id</label>                                        
                                        <select name="select_tenderere_id">
                                            <%
                                                PreparedStatement ps_tenderer = con.prepareStatement("select * from result_tender group by tenderer_id");
                                                ResultSet rs_tenderer = ps_tenderer.executeQuery();
                                                while (rs_tenderer.next()) {
                                                    String tenderer_id = rs_tenderer.getString("tenderer_id");
                                                    int tender_id = rs_tenderer.getInt("tender_id");
                                            %>                                        
                                            <option value="<%=tenderer_id%>"><%= tenderer_id%></option>
                                            <% }%>
                                        </select>
                                    </div>
                                    <div class="clearfix"> </div>
