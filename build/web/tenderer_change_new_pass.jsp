                ...
                <div class="content-main">
                    ...
                    <script>
                        function openfileDialog() {
                            $("#fileLoader").on("click", function (e) {
                    ...
                    <div class="blank">
                        <div class="blank-page">
                            <%
                                ...
                                String Current_pass = "";
                                ps = con.prepareStatement("select * from tenderer_login where tenderer_id='" + Tenderer_id + "'");
                                rs = ps.executeQuery();
                                while (rs.next()) {
                            ...
                            <form action="Tenderer_change_pass" method="get" role="form" onsubmit="return validate(this)" class="form-horizontal">
                    ...
                    <%} else {
                            out.println("<Script> alert('You enter password is incorrect'); window.location.replace('tenderer_change_pass.jsp');</script>");
                        }%>
                    <!-- // enter password -->
                    <div class="copy">
