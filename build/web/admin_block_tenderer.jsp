        ...
        <script>
            $(document).ready(function () {
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "admin_block_tenderer_ajax.jsp", //this is my servlet
                        data: "input=" + val1,
                    ...
                    <div class="blank">                                                              
                        <div class="blank-page">
                            <%
                                ...
                                String TENDERER_ID = "";
                                int flag = 0;
                                PreparedStatement ps_tenderer_count = con.prepareStatement("select * from tenderer_login where approve=2 and block = 0");
                                ...
                                if (flag == 1) {
                            %>
                            <form action="Admin_block_tenderer" method="get">
                                <div class="table-css">
                                    <table align="center" id="output">
                                        ...
                                        <%
                                            ...
                                            String tenderer_id = "";
                                            PreparedStatement ps_view_tenderer = con.prepareStatement("select * from tenderer_login where approve = 2 and block = 0 limit 0,5");
