                ...
                <div class="content-main">
                    ...
                    <div class="blank">                                                              
                        <div class="blank-page">
                            <table>
                                <%int flag = 0, i = 0;
                                    PreparedStatement ans_faq1 = con.prepareStatement("SELECT * from faq where whom='" + 0 + "' ");
                                    ResultSet rs_faq1 = ans_faq1.executeQuery();
                                    if (rs_faq1.next()) {

                                        flag = 1;
                                    }
                                    if (flag == 1) {
                                        PreparedStatement ans_faq = con.prepareStatement("SELECT * from faq where whom='" + 0 + "' ");
                                        ResultSet rs_faq = ans_faq.executeQuery();
                                        while (rs_faq.next()) {
                                            ++i;
                                            String a = rs_faq.getString("ans");
                                            System.out.println(a);


                                %>
                                <tr>
                                    <td><h5><%=i + " " + rs_faq.getString("ques")%></h5></td>
                                    <td><input type="image" src="images//plus1.png" class="play" onclick="toggle(this);"/></td>
                                </tr>
                                <tr class="spaceUnder">
                                    <td></td>
                                    <td>  
                                        <form action="Admin_ans_faq" method="get">
                                            <textarea name="txtarea1" placeholder="Your Answer" id="txtarea1" cols="50" rows="4" class="form-control1" style="height: 100px;"><%=rs_faq.getString("ans")%></textarea>
                                            <input type="hidden" value="<%=rs_faq.getString("faq_id")%>" name="id">
                                            <div class="col-sm-8 col-md-offset-2" style="padding-left: 300px;">
