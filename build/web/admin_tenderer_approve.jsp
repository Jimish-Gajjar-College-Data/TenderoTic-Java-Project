        ...
        <script>
            $(document).ready(function () {
                $('#ul1 li').click(function ()
                {
                    var val1 = $(this).text();
                    $.ajax({
                        url: "admin_tenderer_approve_ajax.jsp", //this is my servlet
                        data: "input=" + val1,
                    ...
                    <div class="blank">                                                              
                        <div class="blank-page">
                            <%
                                ...
                                if (flag == 1) {
                            %>
                            <form action="Admin_tenderer_approve" method="get">
                                <div class="table-css">
                                    <table align="center" id="output">
                                        ...
                                        <%
                                            ...
                                            String tenderer_id = "";
                                            PreparedStatement ps_view_tenderer = con.prepareStatement("select * from tenderer_login where approve=0 limit 0,5");
