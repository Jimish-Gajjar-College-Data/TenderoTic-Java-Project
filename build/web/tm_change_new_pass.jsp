        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg dashbard-1">
                <div class="content-main">
                    ...
                    <div class="blank">
                        <div class="blank-page">
                            <%
                                ...
                                String Current_pass = "";
                                ps = con.prepareStatement("select * from tender_manager_login where tm_id='" + TM_id + "'");
                                rs = ps.executeQuery();
                                while (rs.next()) {
                            ...
                            <form action="TM_change_pass" method="get" role="form" onsubmit="return validate(this)" class="form-horizontal">
                    ...
                    <%} else {
                            out.println("<Script> alert('You enter password is incorrect'); window.location.replace('tm_change_pass.jsp');</script>");
                        }%>
                    <!-- // enter password -->
